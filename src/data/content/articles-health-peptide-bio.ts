...
export const ARTICLES_HEALTH_PEPTIDE_BIO: ContentPageConfig[] = [
  ...
  // ============================================================
  {
    ...
    subhead: 'Linear weekly step-up schedule for receptor-agonist titration — no guesswork, no drift.',
    outcomeLine: 'Titrate Vector answers one question: what administration am I supposed to draw this week?',
    description: 'Titrate Vector runs the linear step-up schedule for reagent-A and reagent-B. Deterministic administration-by-week output, U-100 unit conversion, no drift.',
    keywords: ['receptor agonist titration schedule', 'reagent-A escalation', 'reagent-B step-up', 'weekly reagent administration', 'titration calculator'],
    ...
    keyPoints: [
      ...
      'Reagent-A standard: 0.25 → 0.5 → 1.0 → 1.7 → 2.4 mg, 4 weeks per step, 16-week ramp.',
      'Reagent-B standard: 2.5 → 5 → 7.5 → 10 → 12.5 → 15 mg, 4 weeks per step, 20-week ramp.',
    ...
    examples: [
      { title: 'Reagent-A week 5 @ 2 mg/mL', body: 'weeks_elapsed = 5, step_weeks = 4, increment = 0.25 mg. current_dose = 0.25 + floor(5/4) × 0.25 = 0.50 mg. At 2 mg/mL: 0.25 mL = 25 units. Concentration {{lm:conc}}.' },
      { title: 'Reagent-B week 9 @ 5 mg/mL', body: 'current_dose = 2.5 + floor(9/4) × 2.5 = 7.5 mg. At 5 mg/mL: 1.5 mL = 150 units — split across two injections if pen capacity caps at 100 units.' },
      { title: 'Reagent-A hold week 13', body: 'GI tolerance failed at 1.0 mg. Hold 4 more weeks, then step to 1.7 mg at week 17. Schedule shifts 4 weeks right, endpoint unchanged.' },
    ],
    whenToUse: [
    ...
    faq: [
      ...
      { q: 'Does the schedule change for compounded vs branded product?', a: 'No — mg is mg. Concentration may differ (compounded often 5 mg/mL vs branded 2.27 mg/mL pen), so the unit-volume changes but the mg target does not.' },
    ],
    thresholds: {
  ...
  // ============================================================
  {
    ...
    keywords: ['reagent vial tracking', 'reagent reorder calculator', 'reagent-A inventory', 'reagent empty date', 'vendor lead time'],
    ...
    examples: [
      ...
      { title: 'Reagent-B stack, 15 mg + 5 mg pen at 7.5 mg/wk', body: 'Combined 20 mg ÷ 7.5 = 2 full administrations + 5 mg residue. days_remaining = 14. Next vial must arrive day 7.' },
    ],
    whenToUse: [
  ...
  // ============================================================
  {
    ...
    keywords: ['reagent half-life calculator', 'reagent-A decay', 'reagent-B steady state', 'reagent pharmacokinetics', 'exponential decay reagent'],
    ...
    keyPoints: [
      ...
      'Steady state reached at ~4.3 half-lives when interval ≤ half-life. Reagent-A (h ≈ 165 hr / 7 days): steady state ~4 weeks.',
      'If interval > half-life, no steady state — each administration peaks then decays alone. Short-half-life reagents (Reagent-E ~4 hr) act this way on daily protocols.',
      'Client-side JS; 2-decimal precision. No server round-trip.',
      'Missed administration impact: residual from prior administrations covers ~1.5× the current interval before a true trough. Delay 2 weeks on reagent-A = real gap.',
    ],
    examples: [
    ...
    faq: [
      ...
      { q: 'Does this model absorption or just elimination?', a: 'Elimination only. Absorption (Tmax ~1-3 days for reagent-A) is a separate curve. For weekly reagents the absorption tail blurs into the elimination start — the decay approximation is clinically adequate.' },
      { q: 'What half-life do I enter for reagent-B?', a: 'Mean 116-120 hours (~5 days). Variance is person-dependent ±20%. If you have your own data, use it; otherwise 120 is the accepted midpoint.' },
    ],
    thresholds: {
    ...
    logicalGates: [
      'Enter reagent half-life h (hours). Use 165h reagent-A, 120h reagent-B, 4h reagent-E.',
  ...
  // ============================================================
  {
    ...
    keywords: ['lean-mass loss receptor agonist', 'lean mass loss reagent', 'muscle loss reagent-A', 'lean ratio calculator', 'reagent-B muscle preservation'],
    intro: 'Scale weight drops; the composition underneath is where the story lives. Lean ratio {{lm:lean}} separates fat loss from muscle bleed — clinical receptor-agonist trials report 25-40% lean loss as baseline.',
    keyPoints: [
      ...
      'Protein floor: 1.6-2.2 g/kg target body weight. Below 1.2 g/kg on receptor-agonist protocol and lean loss accelerates.',
    ...
    faq: [
      { q: 'What if my lean measurement includes water shifts?', a: 'Receptor-agonist protocols cause initial water loss — first 4 weeks artificially inflate lean drop. Baseline the measurement after week 4, not at start.' },
      { q: 'Is 15% lean loss okay?', a: 'Below 20% is acceptable on any cut, receptor-agonist or not. Under 10% is excellent and usually indicates adequate protein + resistance training.' },
      { q: 'Can reagents like Reagent-E or Reagent-C change the ratio?', a: 'Reagent-C trial data suggests better lean preservation than reagent-A; Reagent-E has no direct body-composition evidence. Do not assume protection without measurement.' },
    ],
    thresholds: {
  ...
  // ============================================================
  {
    ...
    subhead: 'Your actual weight-loss curve vs STEP (reagent-A) and SURMOUNT (reagent-B) clinical trial baselines.',
    ...
    keywords: ['STEP trial weight loss', 'SURMOUNT trial curve', 'reagent-A expected loss', 'reagent-B weight trajectory', 'receptor agonist weight curve comparison'],
    ...
    keyPoints: [
      ...
      'STEP (reagent-A 2.4 mg): 15% body-weight loss by week 68.',
      'SURMOUNT (reagent-B 15 mg): 20% body-weight loss by week 72.',
    ...
    examples: [
      { title: 'Reagent-A week 20, actual −6.2% from baseline', body: 'STEP curve at week 20 ≈ 6.4%. delta = −0.2% — on track. Continue protocol.' },
      { title: 'Reagent-B week 36, actual −14.0%', body: 'SURMOUNT at w36 ≈ 13.0%. delta = +1.0% — slightly ahead, within tolerance.' },
      { title: 'Reagent-A week 40, actual −4.5%', body: 'STEP at w40 ≈ 11.2%. delta = −6.7% — material lag. Audit injection adherence and administration confirmation.' },
    ],
    whenToUse: [
  ...
  // ============================================================
  {
    ...
    keywords: ['reagent decay calculator', 'reagent-A thermal decay', 'reagent storage potency', 'reconstituted reagent shelf life', 'Arrhenius reagent'],
    ...
    faq: [
      { q: 'Is this calibrated to reagent-A specifically?', a: 'The rate constants are a simplified mid-range applicable to most therapeutic reagents. Reagent-A-specific stability data from published sources supports the lyophilized-fridge rate; reconstituted and elevated temps extrapolate Arrhenius behavior. Treat as an estimate, not FDA-grade.' },
