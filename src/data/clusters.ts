...
export const CLUSTERS: ClusterConfig[] = [
  ...
  },
  {
    ...
    intro: 'Daily word and anagram puzzles refresh at 4am Eastern (ET) — early morning in North America, mid-morning in Europe, afternoon in Asia. Sudoku difficulty rooms keep a separate saved board each. This cluster groups the repeat-visit pages and the strategy tips that help your scores over time.',
    ...
    startHere: [
      { href: '/games/daily-word/', label: "Today's daily word", note: '5-letter anagram — new each day at 4am ET.' },
    ...
    faq: [
      ...
      { q: 'What is a better daily word game than Wordle?', a: 'If you want a game that changes shape rather than repeating the same 5-letter format, try the Daily Anagram, Daily Unscramble, or the Vibe Games cluster. Hunt, Hive, and Sudoku all refresh at 4am ET each day.', faq_intent: 'comparison' },
      { q: 'What is the most popular daily word game?', a: 'Wordle is the best-known, but "most popular" depends on the platform. Kefiw offers several alternatives \u2014 Daily Word, Daily Anagram, Daily Unscramble, and multiple Vibe puzzles \u2014 so you can rotate instead of playing the same format every day.', faq_intent: 'comparison' },
      { q: 'Are these daily word games free?', a: 'Yes. Every daily puzzle on Kefiw runs in the browser with no sign-up, no download, and no paywall. Play offline once the page loads.', faq_intent: 'trust' },
      { q: 'Are word games good for the brain?', a: 'Daily word and number puzzles provide low-effort cognitive exercise \u2014 word retrieval, pattern recognition, short-term memory, and attention. Consistent daily play is more valuable than occasional intense sessions, and variety (different formats) works the most different brain regions.', faq_intent: 'definition' },
      { q: 'What word games are good for seniors?', a: 'Pick games with readable type, simple rules, and forgiving mechanics \u2014 Sudoku (easy / medium rooms), Daily Word with its one-word-per-day format, and Hive (letter grids) all fit. Kefiw\u2019s games run offline once loaded and have no sign-in, so they are easy to pass between family members on a shared device.', faq_intent: 'how-to' },
    ],
