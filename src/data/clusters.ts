...
export const CLUSTERS: ClusterConfig[] = [
  // ---------- PHASE A ----------
  {
    ...
    featuredSupportIds: [
      ...
      'art-wd-words-with-friends-scoring-guide',
      'art-wd-7-letter-word-finder-guide',
    ],
    startHere: [
  ...
  },
  {
    ...
    featuredSupportIds: [
      ...
      'cE-wordle-strategy',
      'cE-crossword-pattern-tips',
      'art-wd-6-letter-word-finder-guide',
    ],
    startHere: [
  ...
  },
  {
    ...
    intro: 'Use this rhyme and syllable hub when the writing is close but the sound is not landing yet. The tools help with the mechanical checks: finding words with similar endings, counting syllables, checking line length, and validating a 5-7-5 haiku shape. The guides explain the craft around those checks so a poem, lyric, or short verse sounds natural instead of forced.',
    description: 'Find spelling-based rhyme ideas, count syllables, check 5-7-5 haiku structure, and learn how to shape stronger poems, songs, and short verse.',
    ...
    featuredSupportIds: [
      ...
      'cS-how-to-write-a-rhyming-poem',
    ...
    faq: [
      { q: 'Is the Rhyme Finder phonetic?', a: 'No. The current Rhyme Finder is spelling-based and matches trailing letter patterns from a large English word list. It is useful for brainstorming, but final rhyme choices should be read aloud because English spelling does not always match pronunciation.', faq_intent: 'trust' },
      { q: 'Which tool should I use first for a poem?', a: 'Start with the Rhyme Finder when you need ending-word ideas, then use the Syllable Counter to test rhythm. If the poem is a haiku, use the Haiku Checker after drafting three lines.', faq_intent: 'how-to' },
      { q: 'Why do rhyme and syllable tools sometimes disagree with my ear?', a: 'Automated tools use rules, lists, or patterns, while poems are heard through pronunciation, accent, and performance. Treat the tools as drafting aids, then read the line aloud before making the final choice.', faq_intent: 'troubleshooting' },
      { q: 'Can these tools help with songs and rap lyrics?', a: 'Yes. The tools can help with rhyme options, line length, and draft structure for lyrics. Songs and rap also depend on beat, stress, delivery, and phrasing, so the strongest test is still speaking or singing the line aloud.', faq_intent: 'how-to' },
    ],
  ...
  },
  {
    ...
    featuredListIds: [],
    featuredSupportIds: [
      'art-everyday-calculators-overview',
      ...
      'art-ce-ratio-and-proportion-guide',
      'art-ce-fraction-arithmetic-guide',
      'art-ce-mortgage-prepayment-guide',
    ],
    startHere: [
  ...
  // ---------- PHASE C ----------
  {
    ...
    featuredListIds: [],
    featuredSupportIds: [
      'art-shopping-calculators-overview',
      ...
      'art-ce-discount-math-guide',
      'art-ce-markup-vs-margin-guide',
    ],
    startHere: [
  ...
  },
  {
    ...
    featuredSupportIds: [
      ...
      'art-cv-weight-units-guide',
      'art-cv-temperature-scale-guide',
      'art-cv-area-units-guide',
      'art-cv-volume-units-guide',
      'art-cv-speed-units-guide',
      'art-cv-time-units-guide',
    ],
    startHere: [
  ...
  },
  {
    ...
    intro: 'Kefiw now has three live daily pipelines. Kefiw Daily is the core word-and-logic route with Hunt, Hive, and Sudoku. Kefiw Math adds five short mental-arithmetic dashes. Kefiw Verbal adds five seeded letter-and-word puzzles. They all refresh at 4am Eastern (ET) and are built for repeatable daily play instead of one-off sessions.',
    description: 'Three daily pipelines on Kefiw — Word, Math, and Verbal — plus strategy guides for turning short repeatable play into a routine you actually keep.',
    keywords: ['daily word game', 'daily brain games', 'mental math practice', 'verbal puzzles', 'daily puzzle'],
    ...
    featuredSupportIds: [
      ...
      'cS-daily-kefiw-leaderboard-system',
      'cS-best-free-word-games',
      'art-cg-sudoku-difficulty-levels-guide',
    ],
    startHere: [
      { href: '/daily/', label: 'Kefiw Daily', note: 'Word — Hunt, Hive, Sudoku. Three puzzles, about 10 minutes.' },
      { href: '/daily/math/', label: 'Kefiw Math', note: 'Math — five mental-arithmetic dashes in about 12 minutes.' },
      { href: '/daily/verbal/', label: 'Kefiw Verbal', note: 'Verbal — five letter and word puzzles in about 15 minutes.' },
    ],
    faq: [
      { q: 'When does the daily puzzle reset?', a: '4am Eastern Time (ET). Everyone worldwide gets the same puzzle on the same date \u2014 it just flips at different local clock times depending on where you are.' },
      ...
      { q: 'What is a better daily routine than playing one random puzzle?', a: 'A pipeline is better than a random single game because it mixes task types. Kefiw Daily gives word deduction and logic, Kefiw Math gives numeracy, and Kefiw Verbal gives letter-pattern work.', faq_intent: 'comparison' },
      { q: 'Are these daily pipelines free?', a: 'Yes. Every daily puzzle and daily pipeline on Kefiw runs in the browser with no sign-up, no download, and no paywall. Play offline once the page loads.', faq_intent: 'trust' },
      { q: 'Are these daily games good for the brain?', a: 'They can support daily cognitive engagement, especially because the three pipelines rotate different mental tasks. They are still not a cure, a diagnosis tool, or a replacement for exercise, sleep, hearing care, and blood-pressure control.', faq_intent: 'definition' },
      { q: 'Which pipeline should adults over 40 start with?', a: 'Start with Kefiw Daily because it is the easiest habit to keep: Hunt, Hive, and Sudoku in one short session. Add Math and Verbal once the routine feels stable.', faq_intent: 'how-to' },
      { q: 'What daily games are good for seniors?', a: 'Start with the shortest, clearest routes: Kefiw Daily, easy Sudoku, and Hive-style word search play. The best routine for older adults is short, readable, and repeatable rather than punishing.', faq_intent: 'how-to' },
    ],
  ...
  // ---------- HEALTH ----------
  {
    ...
    featuredListIds: [],
    featuredSupportIds: [
      'art-health-biological-maintenance-overview',
  ...
  },
  {
    ...
    featuredListIds: [],
    featuredSupportIds: [
      'art-health-body-composition-overview',
  ...
  },
  {
    ...
    featuredListIds: [],
    featuredSupportIds: [
      'art-health-structural-output-overview',
  ...
  },
  {
    ...
    featuredListIds: [],
    featuredSupportIds: [
      'art-health-bio-logistics-overview',
  ...
  },
  {
    ...
    featuredListIds: [],
    featuredSupportIds: [
      'art-health-environmental-stressors-overview',
  ...
  },
  {
    ...
    section: 'games',
    hubSlug: 'relationship-games',
    title: 'Fun Relationship Games \u2014 Kefiw',
    h1: 'Fun Relationship Games',
    subhead: 'Date, party, and couple games \u2014 playful, stage-aware, and explicitly not predictions.',
    intro: 'Relationship games now cover three lanes: quick novelty name games, stage-aware date Q&A, and private couple or party decks. Use Love Calculator and FLAMES for laughs, Date Night Questions for first/second/third-date pacing, and the flirty decks when the room is ready.',
    description: 'Date night questions, flirty truth or dare, couples games, love calculator, FLAMES, and relationship conversation games with clear novelty and consent framing.',
    keywords: ['date night questions', 'relationship games', 'couples games', 'flirty truth or dare', 'love calculator', 'fun relationship games'],
    featuredToolIds: [
    ...
    featuredListIds: [],
    featuredSupportIds: [
      'rel-guide-date-night-questions',
      'rel-guide-flirty-games-boundaries',
      'rel-guide-couples-couch-games',
      'rel-guide-party-relationship-games',
    ],
    startHere: [
      { href: '/games/date-night-questions/', label: 'Date Night Questions', note: 'First date, second date, third date, or established couple prompts.' },
      { href: '/games/flirty-truth-or-dare/', label: 'Flirty Truth or Dare', note: 'Date, couple, and party modes with skip-first rules.' },
      { href: '/games/couple-dare-ladder/', label: 'Couple Dare Ladder', note: 'Private adult/couple escalation with level-down and stop controls.' },
      { href: '/games/love-calculator/', label: 'Love Calculator', note: 'Two names \u2192 compatibility percentage, with the math visible.' },
    ],
    faq: [
      { q: 'Are these relationship calculators real?', a: 'No. They are novelty tools that use letter math or quiz answers to produce deterministic results. They are built for fun and conversation, not prediction.', faq_intent: 'trust' },
      { q: 'Is a love calculator accurate?', a: 'No love calculator can predict real relationships. What letter-based tools measure is letter overlap; what signal-based quizzes measure is how you answered the quiz. Real compatibility depends on time, care, and daily choices.', faq_intent: 'trust' },
      { q: 'What is the FLAMES game?', a: 'FLAMES is a 1970s schoolyard game. Write two names, cross out shared letters, count what remains, and cycle through F-L-A-M-E-S (Friends, Lovers, Affectionate, Marriage, Enemies, Siblings) to land on one letter.', faq_intent: 'definition' },
      { q: 'Can you get 100% on a love calculator?', a: 'Some calculators always return numbers near 100 for fun. Kefiw\u2019s smooths its results to the 10\u201390 range to stay honest \u2014 a 100% score would undermine the "for fun" framing.', faq_intent: 'edge-case' },
      { q: 'Which relationship game should I play on a first date?', a: 'Start with Date Night Questions in First Date mode or Couples Would You Rather on Easy intensity. Those formats keep answers light, specific, and skippable. Save spicy, adult/private, or emotionally heavy prompts for later dates or established relationships.', faq_intent: 'how-to' },
      { q: 'Can relationship games be played on two phones?', a: 'Yes, but the new date and couple games use manual turns, not synced multiplayer. Both people can open the same page, choose matching settings, and alternate out loud. This keeps the game private and avoids accounts or shared state.', faq_intent: 'edge-case' },
      { q: 'Are the spicy couple games safe for parties?', a: 'No. Party mode should stay friendly or flirty because group pressure changes consent. Use Flirty Truth or Dare party mode or Red Flag Green Flag for groups, and keep Couple Dare Ladder for private consenting adults.', faq_intent: 'trust' },
    ],
    relatedClusterSlugs: ['daily'],
  },
];
