...
export const CLUSTERS: ClusterConfig[] = [
  ...
  },
  {
    ...
    subhead: 'Novelty compatibility tools \u2014 for laughs, not predictions.',
    intro: 'Three playful, transparent name-and-signal games: a letter-based love calculator, the classic FLAMES schoolyard game, and an 8-question relationship longevity quiz. Every result is deterministic \u2014 same inputs always return the same answer \u2014 and every result is explicitly for fun.',
    description: 'Love calculator, FLAMES name game, and a "how long will we last?" quiz. Deterministic, transparent, and explicitly novelty tools.',
    keywords: ['love calculator', 'flames game', 'relationship quiz', 'name compatibility', 'fun relationship games'],
    featuredToolIds: ['love-calculator', 'flames-calculator', 'how-long-will-we-last'],
    featuredListIds: [],
    featuredSupportIds: [],
    startHere: [
      { href: '/games/love-calculator/', label: 'Love Calculator', note: 'Two names \u2192 compatibility percentage, with the math visible.' },
      { href: '/games/flames-calculator/', label: 'FLAMES Calculator', note: 'The 1970s schoolyard game \u2014 Friends, Lovers, Affectionate, Marriage, Enemies, Siblings.' },
      { href: '/games/how-long-will-we-last/', label: 'How Long Will We Last?', note: 'Eight questions, one estimated years-together figure.' },
    ],
    faq: [
