...
export const TRACKS: Track[] = [
  {
    ...
    finalPlan: {
      ...
      riskFlags: ['missing tear-off scope', 'unclear decking allowance', 'percentage deductible shock', 'low bid without ventilation scope'],
      nextQuestions: ['What is included in the tear-off?', 'How is decking priced?', 'Which warranty is labor-backed?', 'What happens if code upgrades are needed?'],
      checklist: ['roof area', 'pitch', 'material tier', 'insurance deductible', 'quote exclusions', 'repair/replace signal'],
  ...
  },
  {
    ...
    finalPlan: {
      ...
      riskFlags: ['undersized or oversized system', 'ductwork excluded from quote', 'unclear warranty labor term', 'efficiency upgrade without payback'],
  ...
  },
  {
    ...
    finalPlan: {
      ...
      riskFlags: ['too few billable hours', 'tax set-aside missing', 'underpriced revisions', 'software costs ignored'],
      nextQuestions: ['How many hours are actually billable?', 'What tax set-aside is safe?', 'Which expenses are recurring?', 'When should an entity be reviewed?'],
      checklist: ['salary target', 'billable hours', 'overhead', 'tax set-aside', 'expense budget', 'pricing floor'],
      recommendedNextCalculators: [
