...
export const CATEGORIES: Record<ToolCategory, { title: string; slug: string; blurb: string }> = {
  ...
  calculators: {
    ...
    slug: 'calculators',
    blurb: 'Simple calculators for everyday choices: time, money, ratios, and planning. Enter the numbers you know and see the result in plain language.',
  },
  games: {
  ...
  health: {
    title: 'Health',
    slug: 'health',
    blurb: 'Health calculators for body metrics, caffeine timing, alcohol clearance, sleep timing, and warning-sign checks. Formula-based estimates, not medical advice.',
  },
  logic: {
    title: 'Logic',
    slug: 'logic',
    blurb: 'Thinking-load tools for focus, context switching, decision fatigue, and deep-work capacity. Use them to make hidden mental strain visible.',
  },
  finance: {
    title: 'Finance',
    slug: 'finance',
    blurb: 'Money-planning tools for cash runway, burn rate, shock costs, subscriptions, and long-term tradeoffs. Educational math only, not financial advice.',
  },
};
...
const RAW_TOOLS: ToolConfig[] = [
  ...
  },
  {
    ...
    h1: 'Hours Calculator',
    description: 'Calculate hours worked between two times, subtract an unpaid break, and optionally estimate pay.',
    keywords: ['hours calculator', 'time card calculator', 'work hours calculator'],
    intro: 'Enter when work started, when it ended, and how many unpaid break minutes to subtract. The result shows normal hours-and-minutes plus decimal hours for payroll. If you add an hourly rate, it also estimates regular and overtime pay.',
    howTo: [
    ...
    faq: [
      ...
      { q: 'Is overtime calculated?', a: 'Yes, if you open the optional pay section. Enter the hourly rate, the number of worked hours before overtime begins, and the overtime pay rate such as 1.5 for time-and-a-half.' },
  ...
  },
  {
    ...
    h1: 'Revenue per Head',
    description: 'Estimate whether the next hire raises or lowers revenue per employee after management time and ramp-up.',
    keywords: ['revenue per employee', 'hiring decision calculator', 'profit per head', 'operational scaling'],
    intro: 'Current revenue per employee is revenue divided by employee count. The projected version subtracts the full cost of the new hire, adds management time, and assumes the new person is only partly productive while they ramp up.',
    howTo: [
    ...
    examples: [
      { title: '$1.2M/5 vs $1.6M/6 with $95k hire', body: 'Current revenue per employee is $240k. Projected is $260k after hire cost and ramp-up.' },
    ],
    faq: [
      { q: 'Is revenue per employee the right metric?', a: 'It is useful for service businesses. For equipment-heavy businesses, pair it with profit margin and cash-flow checks.' },
      { q: 'What does management time mean?', a: 'It is the extra manager time created by each new person: meetings, reviews, questions, blockers, and coordination.' },
    ],
  ...
  },
  {
    ...
    island: 'ViceToValue',
    followUps: [
      { toolId: 'dopamine-minimum', cta: 'Vice priced. Now find the minimum dopamine hit you need.' },
  ...
  },
  {
    ...
    faq: [
      { q: 'Is 1.0 the right line?', a: 'It is a practical midpoint. Below 1, the energy and money cost outweighs the connection value you entered. Tune it for your own situation.' },
  ...
  },
  {
    ...
    h1: 'Burnout Monitor',
    description: 'Estimate when extra work hours stop being worth the fatigue cost from lost sleep.',
    keywords: ['sleep deprivation calculator', 'cognitive decline sleep', 'overwork calculator', 'burnout math'],
    intro: 'Less sleep usually means weaker focus tomorrow. This tool compares the money from extra work tonight with the productivity you may lose after a short night.',
    howTo: [
      ...
      'Read tonight\'s extra pay, tomorrow\'s estimated loss, and the net tradeoff.',
    ],
    examples: [
      { title: '5h sleep, 3 extra hours, $30/hr', body: 'Extra work pays $90 tonight. The tool estimates tomorrow\'s fatigue cost and shows what is left after that tradeoff.' },
    ],
    faq: [
  ...
  },
  {
    ...
    description: 'Prioritize essential bills first when there is not enough cash to pay everything.',
    keywords: ['strategic default', 'bill prioritization', 'debt triage', 'which bills to skip'],
    intro: 'Group bills by real-world damage if they go unpaid: housing and utilities first, then vehicle needs, then phone or internet, then unsecured debt. The tool applies available cash to the highest-risk bills first.',
    howTo: [
    ...
    examples: [
      { title: '$600 cash, $1200 rent first', body: 'Rent is still short. The tool marks the essential bill as uncovered before lower-priority bills get paid.' },
    ],
    faq: [
  ...
  },
  {
    ...
    h1: 'Asset Liquidator',
    description: 'Compare gig earnings with the estimated vehicle wear created by the miles driven.',
    keywords: ['gig driver calculator', 'irs mileage', 'uber lyft doordash cost', 'real hourly gig'],
    intro: 'Real profit is gross pay minus an estimated cost per mile. The mileage cost represents fuel, depreciation, insurance, tires, and repairs. Some gig shifts look profitable until the car cost is counted.',
    howTo: [
  ...
  },
  {
    ...
    h1: 'Social Latency',
    description: 'Compare the benefit of a social plan against the time, energy, and money it costs.',
    keywords: ['social roi', 'energy expenditure calculator', 'connection intensity', 'neural synchrony'],
    intro: 'Use three inputs: how much energy the plan costs, how much money it costs, and how valuable the connection feels. The result is a simple go-or-wait signal.',
    howTo: [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'How accurate is the growth projection?', a: 'It compounds monthly at the rate you enter. Real-world returns vary, so treat the projection as an estimate.' },
    ],
  ...
  },
  {
    ...
    description: 'Plot the half-life decay of caffeine or alcohol. See when the intake drops below the jitter threshold and the sleep-interference threshold.',
    keywords: ['caffeine half life', 'alcohol half life', 'pharmacokinetic calculator', 'when caffeine wears off'],
    intro: 'Caffeine half-life ≈ 5 h, alcohol ≈ 1.5 h (elimination, not BAC decline). Plots the exponential decay curve so you can see when the intake crosses the jitter line and the sleep-interference line.',
    howTo: [
      'Pick caffeine or alcohol.',
      'Enter intake mg and hours since consumption.',
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is 2 g/kg too much protein?', a: 'No. Meta-analyses (Morton 2018) show 1.6 g/kg saturates MPS; higher intakes are neutral. Upper-bound safety supported to 3.5 g/kg for renal-healthy adults.' },
    ],
  ...
  },
  {
    ...
    description: 'Per-meal protein bolus that maximises muscle protein synthesis. 0.25-0.40 g/kg per feeding, 1.6-2.2 g/kg daily.',
    ...
    faq: [
      ...
      { q: 'Can I front-load all my protein?', a: 'Single 120 g bolus activates MPS no more than 40 g. Spread boluses across meals.' },
    ],
  ...
  },
  {
    ...
    description: 'Minutes to a Minimum Erythemal Threshold by Fitzpatrick skin type and UV Index. Protected time via SPF.',
    keywords: ['UV index calculator', 'burn time calculator', 'Fitzpatrick skin type', 'SPF calculator'],
    intro: 'Minimum Erythemal Threshold (MED) varies by Fitzpatrick type — type I burns at 200 J/m², type VI at 1000 J/m². At UV Index 1 ≈ 25 mW/m² erythemally weighted, burn_min = MED / (UVI × 1.5).',
    howTo: [
    ...
    island: 'UvExposure',
    followUps: [
      { toolId: 'thermal-failure', cta: 'Sun logged. Now model the heat failure point.' },
  ...
  },
  {
    ...
    intro: 'Satish 2012 and Allen 2016 established an exposure-response: at 1000 ppm, strategic thinking drops ~15%; at 1400 ppm, 50%; at 2500, 75%. ASHRAE indoor target: ≤ 1000 ppm. Most offices and bedrooms hit 1200–2500 without mechanical ventilation.',
    howTo: [
  ...
  },
  {
    ...
    followUps: [
      ...
      { toolId: 'uv-exposure', cta: 'Long outdoors? Model the UV exposure too.' },
    ],
  },
  ...
  },
  {
    ...
    followUps: [
      ...
      { toolId: 'transfer-loss', cta: 'Each draw loses dead-space volume. See the annual cost.' },
    ],
  },
  {
    id: 'reagent-μg-ratio',
    ...
    followUps: [
      { toolId: 'reagent-dispense', cta: 'Table ready. Convert a single administration now.' },
      { toolId: 'vector-decay', cta: 'Long-term storage? Estimate shelf-life decay.' },
    ],
  },
  {
    id: 'transfer-loss',
    ...
    description: 'Every syringe retains dead-space volume after the plunger bottoms out. Calculate annual reagent loss in mg and dollars across a year of weekly injections.',
    keywords: ['syringe dead space waste', 'insulin syringe waste volume', 'reagent waste calculator', 'low dead space syringe'],
    ...
    howTo: [
      ...
      'Enter reagent cost per mg for the dollar view.',
    ...
    faq: [
      ...
      { q: 'Are low-dead-space syringes worth it?', a: 'At typical reagent prices, LDS pins pay back within 2–3 months of weekly use.' },
    ],
    relatedIds: ['reagent-dispense', 'reagent-recon', 'vendor-yield'],
    island: 'reagent/TransferLoss',
    followUps: [
      { toolId: 'vendor-yield', cta: 'Waste priced. Compare vendors on cost-per-administration.' },
    ],
  },
  {
    id: 'titrate-vector',
    ...
    relatedIds: ['reagent-dispense', 'reagent-inventory', 'mass-trajectory'],
    island: 'reagent/TitrateVector',
    followUps: [
      { toolId: 'reagent-inventory', cta: 'Schedule set. Forecast when vials run out.' },
      { toolId: 'mass-trajectory', cta: 'Track actual loss against the clinical curve.' },
    ],
  },
  {
    id: 'reagent-inventory',
    category: 'health',
    slug: 'reagent-inventory',
    noindex: true,
    ...
    howTo: [
      ...
      'Enter weekly administration in mg.',
    ...
    relatedIds: ['titrate-vector', 'vendor-yield', 'vector-decay'],
    island: 'reagent/ReagentInventory',
    followUps: [
      { toolId: 'vendor-yield', cta: 'Reorder window open. Compare vendor cost-per-administration.' },
    ],
  },
  {
    id: 'reagent-half-life',
    category: 'health',
    ...
    followUps: [
      { toolId: 'reagent-stack', cta: 'Running multiples? Check stack interaction.' },
    ],
  },
  {
    id: 'reagent-purity',
    ...
    description: 'Correct labelled vial mass for HPLC purity and reagent content. True reagent mg = label mg × purity% × content%.',
    keywords: ['reagent purity correction', 'HPLC content adjustment', 'reagent salt content', 'true reagent mass'],
    intro: 'Labelled mass overstates active reagent. True mg = label × purity × reagent-content-factor. A 10 mg / 95% / 85%-content vial delivers 8.08 mg active.',
    howTo: [
      'Enter label mass (mg).',
      'Enter HPLC purity (%) — from COA.',
      'Enter reagent content factor (%) — accounts for salt and counter-ions.',
    ...
    faq: [
      { q: 'Where do I find purity and content?', a: 'Vendor Certificate of Analysis (COA). Purity from HPLC; reagent content from nitrogen analysis or calculated from salt form.' },
    ...
    relatedIds: ['salt-correction', 'reagent-recon', 'vendor-yield'],
    island: 'reagent/ReagentPurity',
    followUps: [
  ...
  },
  {
    ...
    slug: 'reagent-stack',
    noindex: true,
    title: 'Multi-Reagent Stack — Co-Reconstitution Math | Kefiw',
    h1: 'Reagent Stack · Co-Reconstitution',
    description: 'Planning a multi-reagent stack in one vial or one injection session? Compute combined concentrations, unit draws, and volume totals.',
    ...
    faq: [
      ...
      { q: 'Does stacking change half-life?', a: 'No — each reagent decays independently per its own half-life. Use the Half-Life tool for each separately.' },
    ],
    relatedIds: ['reagent-recon', 'reagent-half-life', 'solubility-limit'],
    island: 'reagent/ReagentStack',
    followUps: [
  ...
  },
  {
    ...
    description: 'Reagents ship as TFA, acetate, or free-base salts. Salt factor shifts active reagent mass by 5–15%. Apply the correction before administering.',
    keywords: ['reagent salt factor', 'TFA correction', 'acetate salt reagent', 'reagent free base conversion'],
    ...
    howTo: [
      ...
      'Read corrected active reagent mass.',
    ],
    examples: [
      { title: '10 mg · TFA salt (12%)', body: 'Active reagent: 8.8 mg · 12% of label is TFA counter-ion.' },
    ],
    faq: [
      ...
      { q: 'Is the salt factor on the COA?', a: 'Usually listed as "net reagent content" or "salt content". If absent, assume TFA 12% for research-grade.' },
    ],
    relatedIds: ['reagent-purity', 'reagent-recon', 'vendor-yield'],
    island: 'peptide/SaltCorrection',
    followUps: [
      { toolId: 'reagent-purity', cta: 'Stack purity on top for the full correction.' },
    ],
  },
  {
    id: 'mass-retention-guard',
    category: 'health',
    ...
    examples: [
      { title: '100 → 90 kg total · 70 → 64 kg lean', body: 'Total loss 10 kg · Lean loss 6 kg · Ratio 0.60 · MAGENTA — severe lean-mass loss trajectory.' },
    ],
    faq: [
    ...
    relatedIds: ['mass-trajectory', 'metabolic-floor', 'fuel-partition'],
    island: 'reagent/MassRetentionGuard',
    followUps: [
      { toolId: 'metabolic-floor', cta: 'Lean mass bleeding. Check your floor.' },
      { toolId: 'mass-trajectory', cta: 'Compare total loss vs the clinical curve.' },
    ],
  },
  {
    id: 'mass-trajectory',
    category: 'health',
    slug: 'mass-trajectory',
    noindex: true,
    ...
    followUps: [
      { toolId: 'mass-retention-guard', cta: 'Losing fast? Check lean-mass cost.' },
    ],
  },
  {
    id: 'vector-decay',
    ...
    slug: 'vector-decay',
    noindex: true,
    title: 'Vector Decay — Thermal Decay & Shelf-Life | Kefiw',
    h1: 'Vector Decay · Thermal Decay',
    description: 'Reconstituted reagents degrade via Arrhenius kinetics. Enter storage temp and days — get residual activity %. Magenta flag below 80%.',
    keywords: ['reagent shelf life', 'reconstituted reagent degradation', 'reagent storage temperature', 'BAC water stability'],
    ...
    howTo: [
      'Enter reagent (sets the reference rate).',
    ...
    faq: [
      ...
      { q: 'Can I freeze reconstituted reagent?', a: 'Generally no — freeze-thaw cycles denature most reagents. Keep unreconstituted vials frozen; refrigerate only after BAC water is added.' },
    ],
    relatedIds: ['substance-decay', 'titrate-vector', 'reagent-inventory'],
    island: 'reagent/VectorDecay',
    followUps: [
      { toolId: 'reagent-inventory', cta: 'Activity low. Reforecast your empty-date.' },
    ],
  },
  {
    id: 'vendor-yield',
    ...
    slug: 'vendor-yield',
    noindex: true,
    title: 'Vendor Cost-per-Administration — Reagent Yield | Kefiw',
    h1: 'Vendor Yield · Cost per Administration',
    description: 'Normalize vendor prices to cost-per-mg and cost-per-administration. Factor shipping, purity, and salt content for a true yield comparison.',
    keywords: ['reagent vendor comparison', 'cost per mg calculator', 'reagent yield', 'best reagent price'],
    intro: 'Cost-per-active-mg = (price + shipping) ÷ (label mg × purity × content). Cost-per-administration = cost-per-mg × administration mg.',
    howTo: [
      'Enter vendor A and B: price, shipping, mg per vial, purity, salt content.',
      'Enter your target administration.',
      'Read cost-per-active-mg and cost-per-administration for each vendor.',
    ...
    relatedIds: ['reagent-purity', 'salt-correction', 'reagent-inventory'],
    island: 'reagent/VendorYield',
    followUps: [
      { toolId: 'reagent-inventory', cta: 'Vendor picked. Forecast the reorder cycle.' },
    ],
  },
  {
    id: 'solubility-limit',
    ...
    description: 'BAC water holds finite reagent mass in solution. Exceeding the limit causes precipitate and uneven administration. Check capacity before stacking.',
    keywords: ['reagent solubility calculator', 'BAC water capacity', 'reagent precipitate', 'max concentration reagent'],
    intro: 'Most research reagents solubilize to 10–20 mg/mL in BAC water. Above that, precipitate forms — visible cloudiness signals uneven concentration.',
    howTo: [
      'Enter total reagent mass (mg) — sum across stack.',
      'Enter BAC volume (mL).',
    ...
    faq: [
      ...
      { q: 'Does temperature help?', a: 'Marginally. Room-temp BAC dissolves slightly better than fridge-cold. Don\'t heat — most reagents denature above 40°C.' },
    ],
    relatedIds: ['reagent-recon', 'reagent-stack', 'salt-correction'],
    island: 'peptide/Solubility',
    followUps: [
      { toolId: 'reagent-stack', cta: 'Capacity OK. Build the stack math.' },
    ],
  },
  {
    id: 'travel-planner',
    ...
    howTo: [
      ...
      'Enter vial concentration and administration mg.',
      'Read manifest: vials, syringes, alcohol swabs, cold-chain duration needed.',
      'Print as carry-on declaration sheet.',
    ],
    examples: [
      { title: '14-day trip · weekly administration · 2 mL vial', body: 'Pack 1 vial + 1 buffer · 3 syringes · 6 swabs · 336 h cold-chain (insulated bag + ice packs).' },
    ],
    faq: [
      { q: 'Can I fly with reagents and syringes?', a: 'Yes, in carry-on with original labeling where possible. TSA allows medication syringes with the prescription medication. International rules vary — research destination country in advance.' },
    ...
    relatedIds: ['reagent-inventory', 'vector-decay', 'transfer-loss'],
  ...
  // ---------- RELATIONSHIP FUN ----------
  {
    ...
    intro: 'A novelty calculator for fun. Enter two names and the tool scores them from three visible signals: shared letters, vowel balance, and a LOVES-letter tally. Same names always give the same score, so try nicknames or full names to see how it changes.',
    ...
    faq: [
      { q: 'Is the love calculator real?', a: 'No. It is a novelty tool. It combines letter overlap, vowel balance, and a LOVES tally into a repeatable percent. It does not know the humans attached to the names.', faq_intent: 'trust' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'What does the years-together number mean?', a: 'It is a repeatable score from your 8 answers. Strong positive answers push toward decades; weak or negative answers push toward months. Changing one answer shifts the number predictably.', faq_intent: 'definition' },
...
const TOOL_OUTCOME_LINES: Record<string, string> = {
  ...
  'hours-calculator': 'Work hours between two times, with unpaid breaks and optional pay.',
  ...
  'hire-vs-automate': 'Compare a person, software, and management time before deciding what to hire or automate.',
  'value-floor': 'Compare doing the work yourself against paying someone else.',
  'cloud-exit': 'Compare ongoing cloud bills with buying and running your own equipment.',
  ...
  'tech-debt-interest': 'Estimate how much extra repair time a shortcut can create later.',
  'revenue-per-head': 'See whether the next hire may raise or lower revenue per employee.',
  'calorie-optimizer': 'Find the most food energy per dollar from a simple ranked list.',
  ...
  'time-to-human': 'Compare the social benefit of going out against travel time, cost, and energy.',
  'dopamine-minimum': 'Pick one visible task when a full to-do list feels too heavy.',
  'trap-detector': 'True APR of a payday loan or pawn deal — and how many times worse than a credit card.',
  'burnout-monitor': 'Estimate when extra work hours stop being worth the fatigue cost.',
  'bio-fuel': 'Compare calories per dollar and how long a basic food budget lasts.',
  'default-optimizer': 'Prioritize essential bills when there is not enough cash for everything.',
  'asset-liquidator': 'Compare short-term gig income with the wear and value lost from your car.',
  'social-latency': 'Estimate whether a social plan is worth the time, cost, and energy.',
  ...
  'liquid-value': 'Check whether selling something to cover a fee creates a bigger replacement cost later.',
  'stability-coefficient': 'Compare paying more rent for peace and privacy against the hours needed to afford it.',
