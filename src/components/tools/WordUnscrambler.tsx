...
export default function WordUnscrambler() {
  ...
  // Client-side filter pipeline. Applied after the worker returns so users can
  // tweak filters without re-running the search.
  ...
  return (
    <div className="space-y-4">
      ...
      <ResultList
        ...
        emptyLabel={results.length > 0 ? 'No words match the active filters.' : 'Type some letters to begin.'}
      />
    </div>
  );
}
