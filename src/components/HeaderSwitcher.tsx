    ...
    sections: [
      {
        ...
        href: '/property/',
        links: [
          { label: 'Property Lab', href: '/property/' },
          { label: 'Home Improvement Lab', href: '/homelab/' },
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'HVAC Replacement Cost', href: '/homelab/#hvac' },
          { label: 'AC Replacement Cost', href: '/homelab/#hvac' },
          { label: 'Furnace Replacement Cost', href: '/homelab/#hvac' },
          { label: 'Heat Pump Cost', href: '/homelab/#hvac' },
          { label: 'Ductwork Cost', href: '/homelab/#hvac' },
          ...
          { label: 'Solar Savings', href: '/homelab/#solar' },
        ],
      },
      {
        label: 'Estimate',
      ...
      },
      {
        ...
        href: '/property/#sell',
        links: [
          { label: 'Seller Proceeds', href: '/property/#sell' },
          { label: 'Closing Costs', href: '/property/#sell' },
          { label: 'Commission', href: '/property/#sell' },
          { label: 'Net Sheet Calculator', href: '/property/#sell' },
          { label: 'Cash to Close', href: '/property/#buy' },
      ...
      },
      {
        ...
        links: [
          { label: 'Property Guides', href: '/property/' },
          { label: 'Home Improvement Guides', href: '/homelab/' },
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'Home Cost by State', href: '/homelab/' },
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'Home Cost by City', href: '/homelab/' },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        href: '/business/#tax',
        links: [
          { label: 'Self-Employed Tax', href: '/business/#tax' },
          { label: 'Quarterly Tax', href: '/business/#tax' },
          { label: 'S-Corp Tax Savings', href: '/business/#tax' },
          { label: 'LLC vs S-Corp', href: '/business/#tax' },
          { label: 'Reasonable Salary', href: '/business/#tax' },
        ],
      },
      {
        label: 'Pricing',
      ...
      },
      {
        ...
        links: [
          { label: 'Hiring Cost', href: '/business/#hiring' },
          { label: 'Contractor vs Employee', href: '/business/#hiring' },
          { label: 'Hire vs Automate', href: '/calculators/hire-vs-automate/' },
          { label: 'Revenue per Employee', href: '/calculators/revenue-per-head/' },
          { label: 'Payroll Burden', href: '/business/#hiring' },
        ],
      },
      {
        label: 'Revenue',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          { label: 'Senior Care Cost', href: '/care/#senior-care' },
          { label: 'Assisted Living Cost', href: '/care/#senior-care' },
          { label: 'Nursing Home Cost', href: '/care/#senior-care' },
          { label: 'Memory Care Cost', href: '/care/#senior-care' },
          { label: 'Home Care Cost', href: '/care/#senior-care' },
        ],
      },
      {
        label: 'Caregiving',
        ...
        links: [
          { label: 'Caregiver Hours', href: '/care/#caregiving' },
          { label: 'Family Care Budget', href: '/care/#caregiving' },
          { label: 'Respite Care Cost', href: '/care/#caregiving' },
          { label: 'Care Needs Checklist', href: '/care/#caregiving' },
        ],
      },
      {
        label: 'Medicare',
        href: '/care/#medicare',
        links: [
          { label: 'Medicare Cost', href: '/care/#medicare' },
          { label: 'Medicare IRMAA', href: '/care/#medicare' },
          { label: 'Part B Premiums', href: '/care/#medicare' },
          { label: 'Part D Estimate', href: '/care/#medicare' },
        ],
      },
      {
        label: 'Insurance',
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'Home Improvement Calculators', href: '/homelab/' },
          { label: 'Roof Replacement Cost', href: '/homelab/roof-replacement-cost-calculator/' },
        ],
      },
      {
